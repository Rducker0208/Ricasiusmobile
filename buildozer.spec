...
# (str) Package name
package.name = Ricasius

# (str) Package domain (needed for android/ios packaging)
package.domain = org.rducker
...
presplash.filename = Resources/app_images/zeus_splash_screen.jpg

# (str) Icon of the application
icon.filename = Resources/app_images/zeus_app_icon.jpg
...
android.permissions = android.permission.VIBRATE, (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18)
